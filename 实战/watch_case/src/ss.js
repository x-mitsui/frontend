      ...
      3: [
        function (require, module, exports) {
          ...
          var normalizeParseOptions = function normalizeParseOptions(opts) {
            ...
            return {
              allowDots:
                typeof opts.allowDots === "undefined" ? defaults.allowDots : !!opts.allowDots,
              allowPrototypes:
              ...
              arrayLimit:
                typeof opts.arrayLimit === "number" ? opts.arrayLimit : defaults.arrayLimit,
              charset: charset,
              charsetSentinel:
                ...
                if (generateArrayPrefix === "comma" && encodeValuesOnly) {
                  ...
                  for (var i = 0; i < valuesArray.length; ++i) {
                    valuesJoined +=
                      (i === 0 ? "" : ",") +
                      formatter(
                        encoder(valuesArray[i], defaults.encoder, charset, "value", format)
                      );
                  }
            ...
            return {
              ...
              charsetSentinel:
                typeof opts.charsetSentinel === "boolean"
                  ...
                  : defaults.charsetSentinel,
              delimiter:
                typeof opts.delimiter === "undefined" ? defaults.delimiter : opts.delimiter,
